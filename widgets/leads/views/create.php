...
<div class="row">
    <div class="col-md-12">
        <div class="widget-add-btn-container">
            <?= Html::a('Добавить сделку', 'javascript:void(0);', [
                'class' => 'btn btn-primary pull-right show-btn',
                'data-container-selector' => '#leadsCreateWidgetFormContainer',
            ]) ?>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <?php Pjax::begin([
            ...
            'options' => [
                ...
                'data-reload-container' => '#pjaxLeadList',
            ],
        ]); ?>
        <div id="leadsCreateWidgetFormContainer" class="widget-form-container" style="<?php if ($hide): ?>display: none;<?php endif; ?>">
            <div class="card">
                <div class="card-head style-primary">
                    <header>Добавление сделки</header>
                    <div class="tools">
                        <a class="btn btn-icon-toggle hide-btn" data-container-selector="#leadsCreateWidgetFormContainer"><i class="md md-close"></i></a>
                    </div>
                </div>
                <div class="card-body">
