...
class NaturalForm extends Model
{
    /**
     * @var $natural Natural
    ...
    public function saveContactsInfos()
    {
        ...
        foreach ($this->contactsInfos as $contactsInfo) {
            $contactsInfo->contact_id = $this->natural->id;
        ...
        $query = ContactsInfos::find()->andWhere(['contact_id' => $this->natural->id]);
    ...
    public function saveAdditionFieldsValues()
    {
        ...
        foreach ($this->additionFieldsValues as $additionFieldsValue) {
            $additionFieldsValue->foregin_table_id = $this->natural->id;
        ...
        $query = AdditionFieldsValues::find()->andWhere(['foregin_table_id' => $this->natural->id]);
    ...
    public function saveContactsLink()
    {
        ...
        foreach ($this->contactsLink as $contactsLink) {
            $contactsLink->contacts_id = $this->natural->id;
        ...
        $query = ContactsLink::find()->andWhere(['contacts_id' => $this->natural->id]);
    ...
    {
        if ($natural instanceof Natural) {
            $this->natural = $natural;
        } elseif (is_array($natural)) {
            $this->natural->setAttributes($natural);
        }
    }
    ...
    public function getContactsInfos()
    {
        if ($this->contactsInfos === null) {
            $this->contactsInfos = $this->natural->isNewRecord ? [] : $this->natural->contactsInfos;
        }
    ...
    public function getAdditionFieldsValues()
    {
        if ($this->additionFieldsValues === null) {
            $this->additionFieldsValues = $this->natural->isNewRecord ? [] : $this->natural->additionalValues;
        }
    ...
    public function getContactsLink()
    {
        if ($this->contactsLink === null) {
            $this->contactsLink = $this->natural->isNewRecord ? [] : $this->natural->contactsLinks0;
        }
