...
/* @var $model app\models\NaturalSearch */
...
<div class="row">
    <div class="contacts-search">
        ...
        <?php if (Yii::$app->user->can('importContacts')): ?>
        <div class="col-lg-2 col-sm-4 col-lg-offset-7">
            <div class="card">
                <div class="card-body small-padding">
                    <?= Html::a('<i class="fa fa-upload"></i> Импорт',
                        ['import'], ['class' => 'btn btn-primary']
                    ) ?>
                </div><!--end .card-body -->
            </div><!--end .card -->
        </div>
